...
> Status index (USER_STORIES.md): done 12 | partial 5 | planned 2 | cut 2.
> Latest amendment: MAIL-A9 — AppLaunch: a landing page can open an app borderless (52 `.idea`s) {#MAIL-A9}
