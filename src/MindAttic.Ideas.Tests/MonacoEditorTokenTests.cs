...
public class MonacoEditorTokenTests
{
    ...
    [TestCase(ContentKind.Widget, "tooltip",       1, "tooltip",       1)]
    [TestCase(ContentKind.Widget, "my.complex.key", 5, "my.complex.key", 5)]
    ...
    public void IntelliSenseToken_InsertedInBody_ParsedByIncludeReferenceParser()
    {
        ...
        var token = FormatToken(ContentKind.Widget, "tooltip", 1);
