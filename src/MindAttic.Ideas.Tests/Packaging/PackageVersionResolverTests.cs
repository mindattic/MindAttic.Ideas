...
{
    private static IdeaManifest Candidate(int version, string key = "ui.tooltip", string category = "Component") =>
    ...
    private static InstalledRef Installed(int version, bool enabled = true, bool active = false,
        string key = "ui.tooltip", string category = "Component") =>
    ...
    public void ResolveLatest_PicksMaxEnabled_IgnoresDisabled()
    {
        ...
        Assert.That(PackageVersionResolver.ResolveLatest("Component", "ui.tooltip", set), Is.EqualTo(2));
    }
    ...
    public void ResolveLatest_NullWhenNoneEnabled()
    {
        ...
        Assert.That(PackageVersionResolver.ResolveLatest("Component", "ui.tooltip", set), Is.Null);
    }
