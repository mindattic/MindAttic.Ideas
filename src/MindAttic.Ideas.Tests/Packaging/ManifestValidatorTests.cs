...
{
    private static IdeaManifest Code(string key = "ui.tooltip", int version = 1, string category = "Component",
        int? sdk = 1, string? entry = "MindAttic.Ideas.Component.Demo.V1") =>
