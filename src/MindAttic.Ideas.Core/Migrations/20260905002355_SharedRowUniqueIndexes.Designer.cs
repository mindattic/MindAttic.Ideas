...
namespace MindAttic.Ideas.Core.Migrations
{
    ...
    [Migration("20260905002355_SharedRowUniqueIndexes")]
    partial class SharedRowUniqueIndexes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MindAttic.Ideas.Core.Entities.CmsContentDefinition", b =>
                {
                    ...
                    b.HasIndex("Kind", "Key", "Version", "Origin", "SiteId")
                        .IsUnique()
            ...
            modelBuilder.Entity("MindAttic.Ideas.Core.Entities.ComponentMetadata", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PageUid", "ComponentKey", "SlotName")
                        .IsUnique();
            ...
            modelBuilder.Entity("MindAttic.Ideas.Core.Entities.InstalledPackage", b =>
                {
                    ...
                    b.HasIndex("Category", "Key", "Version", "SiteId")
                        .IsUnique()
                        .HasFilter("[SiteId] IS NOT NULL");
            ...
            modelBuilder.Entity("MindAttic.Ideas.Core.Entities.Site", b =>
                {
                    ...
                    b.Property<int>("IdleGraceMinutes")
                        .HasColumnType("int");
