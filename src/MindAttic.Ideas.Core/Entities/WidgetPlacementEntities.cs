...
/// <summary>
/// Host-managed per-placement settings for a named widget slot on a page. Stores settings outside of the
...
public sealed class WidgetPlacementSettings
{
    ...
    public string WidgetRef { get; set; } = "";        // e.g. "Widget.hero@1" — which widget owns this slot
    public string SettingsJson { get; set; } = "{}";  // widget-specific settings bag (schema is widget-defined)
