...
dotnet run --project src/MindAttic.Ideas.Blazor -- --import-idealist seed/mindattic-site.idealist
```
...
```pwsh
dotnet run --project src/MindAttic.Ideas.Blazor -- --export-idealist seed/mindattic-site.idealist
```
